  ...
  return (
    <div className="mt-8">
      <h2 className="text-2xl font-bold text-gray-800 mb-6">
        {t("allMasters.singleMaster.reviews")}
      </h2>
      <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
            <p className="text-sm font-medium text-blue-600">
              {t("allMasters.singleMaster.totalReviews")}
            </p>
          ...
          <div className="bg-green-50 p-4 rounded-lg border border-green-100">
            <p className="text-sm font-medium text-green-600">
              {t("allMasters.singleMaster.avgRating")}
            </p>
          ...
          <div className="bg-purple-50 p-4 rounded-lg border border-purple-100">
            <p className="text-sm font-medium text-purple-600">
              {t("allMasters.singleMaster.totalScore")}
            </p>
          ...
          <div className="bg-amber-50 p-4 rounded-lg border border-amber-100">
            <p className="text-sm font-medium text-amber-600">
              {t("allMasters.singleMaster.normalizedScore")}
            </p>
        ...
        {reviews.recent.length > 0 && (
          <div className="mt-6">
            <h3 className="text-xl font-semibold text-gray-800 mb-4">
              {t("allMasters.singleMaster.recentReviews")}
            </h3>
                  ...
                  {review.hasReply && (
                    <div className="bg-gray-50 p-4 rounded-lg mt-3 border-l-4 border-blue-500">
                      <p className="font-medium text-sm text-blue-600 mb-2">
                        {t("allMasters.singleMaster.masterReply")}
                      </p>
