...
export function AdminRecentActivities({ data }: AdminRecentActivitiesProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>{t("adminDashboard.recentActivities.title")}</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <div>
            <h4 className="font-medium mb-3">
              {t("adminDashboard.recentActivities.latestUsers")}
            </h4>
            <div className="space-y-2">
              {data.recentActivities.latestUsers.slice(0, 3).map((user) => (
          ...
          <div>
            <h4 className="font-medium mb-3">
              {t("adminDashboard.recentActivities.latestLeads")}
            </h4>
            <div className="space-y-2">
          ...
          <div>
            <h4 className="font-medium mb-3">
              {t("adminDashboard.recentActivities.latestReviews")}
            </h4>
            <div className="space-y-2">
          ...
          <div>
            <h4 className="font-medium mb-3">
              {t("adminDashboard.recentActivities.latestQuestions")}
            </h4>
            <div className="space-y-2">
