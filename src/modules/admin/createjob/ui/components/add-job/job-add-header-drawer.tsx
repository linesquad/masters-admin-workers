import { DrawerHeader, DrawerContent, Drawer, DrawerTrigger, DrawerTitle, DrawerDescription } from "@/components/ui/drawer";
  ...
  return (
    <>
     <Drawer open={isOpen} onOpenChange={setIsOpen}>
                ...
                <DrawerContent className="max-h-[85vh] bg-white flex flex-col" onOpenAutoFocus={(event) => event.preventDefault()}>
