  ...
  return (
    <>
      <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6">
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              name="city"
              placeholder={t("profileSettings.enterYourCity")}
      ...
      <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6">
        ...
        <div className="space-y-2">
          <label className="block text-sm font-medium text-slate-700 cursor-pointer">
            {t("profileSettings.uploadProfilePicture")}
          </label>
      ...
      <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6">
        <h2 className="text-xl font-semibold text-slate-800 mb-6 flex items-center gap-2">
          <FileText className="size-5 text-blue-600" />
          {t("profileSettings.aboutMe")}
        </h2>
        <div className="space-y-2">
          <label className="block text-sm font-medium text-slate-700 cursor-pointer">
            {t("profileSettings.professionalBio")}
          </label>
          <Textarea
            name="bio"
            placeholder={t("profileSettings.tellPotentialClientsAboutYourself")}
            className="min-h-32 focus-visible:border-blue-500 focus-visible:ring-blue-500/20 cursor-text resize-none"
            onChange={handleBioChange}
          />
          {errors.bio && <p className="text-sm text-red-600">{errors.bio}</p>}
          <p className="text-xs text-slate-500">{bioLength}/500 characters</p>
        </div>
      </div>
    </>
  );
