    ...
    <Card className="w-full max-w-md mx-auto mb-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-gray-500">
              {
                review.lead.jobTitle[
                  i18n.language as keyof typeof review.lead.jobTitle
                ]
              }
            </p>
          </div>
      ...
      <CardContent className="pt-2 space-y-3">
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="flex flex-col items-center bg-gray-50 rounded p-2">
            <span className="text-xs font-medium mb-1">
              {t("reviews.reviewVard.punctuality")}
            </span>
          ...
          <div className="flex flex-col items-center bg-gray-50 rounded p-2">
            <span className="text-xs font-medium mb-1">
              {t("reviews.reviewVard.experience")}
            </span>
        ...
        {review.masterReply && (
          <div className="bg-gray-100 rounded p-2">
            <p className="text-xs font-medium mb-1">
              {t("reviews.reviewVard.yourReply")}
            </p>
        ...
        >
          {review.masterReply
            ? t("reviews.reviewVard.editReply")
            : t("reviews.reviewVard.addReply")}
        </button>
      </CardContent>
    </Card>
  );
